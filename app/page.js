  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        ...
        >
          <svg className="w-5 h-5 animate-phone-ring" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex flex-col items-center justify-center gap-0.5 btn-gold mahindra-theme-btn !py-2 !px-0 !rounded-none"
        >
        ...
        {/* <a
          href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Vinayak%2021%20Acers"
